            ...
            <Col style={{maxWidth: "1100px"}} className="ml-1 ml-md-3 mr-2">
                ...
                <div className="my-4 ml-2 ml-sm-4" id="about-content">
                    ...
                    <h4>How</h4>
                        ...
                        <p>Each link entered to the main input field, upon successful validation in the frontend, is stored in the database as a "long URL." Then, if the user does not enter a custom link, the backend server randomly generates a unique 8-character-long string and associates it with the long URL as its corresponding "short URL." These data are stored in the database ready for retrieval.</p>
                        ...
                        <p className="font-italic"><a href="https://github.com/giobugtong" target="_blank">Smol source code</a></p>
                    <h4>Who</h4>
